...
class CTaskDepMemberCtr extends CMultiRowControl {
			...
			try {
				...
				self::$instance = new CUserDepMemberControl(
						new CMultiRowOfTable($dbpool->getDefaultConnection(),
								mbs_tbname('task_dep_member'), 'dep_id', $primarykey, 'member_uid'),
						$memconn ? new CMultiRowOfCache($memconn, $primarykey, 'CTaskDepMemberCtr') : null
				);
			} catch (Exception $e) {
				throw $e;
			}
