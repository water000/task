...
<style type="text/css">
td .title{font-weight:bold;font-size:120%;}
.date {font-size:80%;font-weight:normal;margin-left:20px;}
td .abstract{color:#555;font-size:80%;margin:10px 5px;}
		...
		<form class="pure-form" method="post" name="_form" action="<?php echo $mbs_appenv->toURL('edit')?>">
			<table class="pure-table" style="width: 100%;margin-top:1em;">
			    <thead>
			        <tr>
			            <th>ID</th>
			            <th style="width: 80%"><?php echo $mbs_appenv->lang('content')?></th>
			    ...
			    <tbody>
			        ...
			        <tr <?php echo 1 == $k%2 ? 'class=pure-table-odd':'' ?>>
			            ...
			            <td>
				            ...
				            <?php } ?>
				            <span class=date><?php echo date('Y-m-d H:i:s', $row['create_time'])?></span>
			            </td>
